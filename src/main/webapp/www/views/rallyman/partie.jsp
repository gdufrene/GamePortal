					...
					<div id="plateau">
						...
						<table id="circuit">
									...
									<c:if test="${cellule.type == 'ligne droite'}">
										...
										<c:choose>
											...
											<c:when test="${estHorizontal}">
												...
												<td><c:choose>
														<c:when test="${cellule.limitationVitesse == 1 }">
															<img src="resources/case_droit_hori_1.jpg" />
														</c:when>
														<c:when test="${cellule.limitationVitesse == 2 }">
															<img src="resources/case_droit_hori_2.jpg" />
														</c:when>
														<c:when test="${cellule.limitationVitesse == 3 }">
															<img src="resources/case_droit_hori_3.jpg" />
														</c:when>
														<c:when test="${cellule.limitationVitesse == 4 }">
															<img src="resources/case_droit_hori_4.jpg" />
														</c:when>
														<c:when test="${cellule.limitationVitesse == 5 }">
															<img src="resources/case_droit_hori_5.jpg" />
														</c:when>
													</c:choose></td>
											</c:when>
											<c:when test="${!estHorizontal}">
												<td><c:choose>
														<c:when test="${cellule.limitationVitesse == 1 }">
															<img src="resources/case_droit_ver_1.jpg" />
														</c:when>
														<c:when test="${cellule.limitationVitesse == 2 }">
															<img src="resources/case_droit_ver_2.jpg" />
														</c:when>
														<c:when test="${cellule.limitationVitesse == 3 }">
															<img src="resources/case_droit_ver_3.jpg" />
														</c:when>
														<c:when test="${cellule.limitationVitesse == 4 }">
															<img src="resources/case_droit_ver_4.jpg" />
														</c:when>
														<c:when test="${cellule.limitationVitesse == 5 }">
															<img src="resources/case_droit_ver_5.jpg" />
														</c:when>
													</c:choose></td>
							</tr>
							</c:when>
							...
							<c:if test="${cellule.type == 'virage'}">
								...
								<td><c:choose>
										<c:when test="${cellule.limitationVitesse == 1 }">
											<img src="resources/case_virage_gauche_1.jpg" />
										</c:when>
										<c:when test="${cellule.limitationVitesse == 2 }">
											<img src="resources/case_virage_gauche_2.jpg" />
										</c:when>
										<c:when test="${cellule.limitationVitesse == 3 }">
											<img src="resources/case_virage_gauche_3.jpg" />
										</c:when>
										<c:when test="${cellule.limitationVitesse == 4 }">
											<img src="resources/case_virage_gauche_4.jpg" />
										</c:when>
										<c:when test="${cellule.limitationVitesse == 5 }">
											<img src="resources/case_virage_gauche_5.jpg" />
										</c:when>
									</c:choose></td>
								<c:choose>
									<c:when test="${!estHorizontal}">
